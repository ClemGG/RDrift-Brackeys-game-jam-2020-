...
public class PIDController
{
	...
	public float pCoeff = .4f;
	public float iCoeff = 3f;
	public float dCoeff = .05f;


	//minimum et maximum influencent sur l'intervalle d'erreur pour la flotaison.
	//Si cet intervalle est trop grand, la planche aura plus de mal à sauter.
	//Je les laisse à leur valeur par défaut pour avoir un saut correct.
